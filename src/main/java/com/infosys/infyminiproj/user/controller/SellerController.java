...
public class SellerController {
	...
	public ResponseEntity<String> createSeller(@Valid @RequestBody SellerDTO sellerDTO) throws InfyMiniProjException {
		try {
	...
	public ResponseEntity<List<SellerDTO>> getAllSeller() throws InfyMiniProjException {
		try {
	...
	public ResponseEntity<String> deleteSeller(@PathVariable String sellerid) throws InfyMiniProjException {
		try {
